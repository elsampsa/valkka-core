...
options="-Dvalgrind_gpu_debug=OFF -Dno_late_drop_debug=OFF -Davthread_verbose=OFF -Ddecode_verbose=OFF -Dload_verbose=OFF -Dpresent_verbose=OFF -Drender_verbose=OFF -Dfifo_verbose=OFF -Dtiming_verbose=OFF -Dopengl_timing=OFF -Dfile_verbose=OFF -Dfifo_diagnosis=OFF"
