...
void test_1() {  
  const char* name = "@TEST: classes_test: test 1: ";
  std::cout << name <<"** @@Copy-construction of some classes **" << std::endl;
  FrameFifo  fifo1("fifo",10);
  // FrameFifo  fifo2=fifo1;
}


void test_2() {
  
  const char* name = "@TEST: classes_test: test 2: ";
...
void test_3() {
  ...
  const char* name = "@TEST: classes_test: test 3: ";
  std::cout << name <<"** @@DESCRIPTION **" << std::endl;
...
void test_4() {
  ...
  const char* name = "@TEST: classes_test: test 4: ";
  std::cout << name <<"** @@DESCRIPTION **" << std::endl;
...
void test_5() {
  ...
  const char* name = "@TEST: classes_test: test 5: ";
  std::cout << name <<"** @@DESCRIPTION **" << std::endl;
