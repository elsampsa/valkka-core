...
class OpenGLThread:
  ...
  def __init__(self,**kwargs):
    ...
    # some "api-level 1" objects here = swig-wrapped cpp objects
    #
    # This parameter set is defined at the cpp header file "openglframefifo.h"
    ...
    self.active=True
    if (self.verbose): print(self.pre,"starting core.OpenGLThread")
    self.core.startCall()
    if (self.verbose): print(self.pre,"started core.OpenGLThread")
